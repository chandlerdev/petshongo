...
namespace Sm\PetShop\Model\Import;
...
class Cms
{
    ...
    public function __construct(
        ...
        $this->_importPath = BP . '/app/code/Sm/PetShop/etc/import/';
    ...
    public function importCms($type)
    {
        ...
        try {
            ...
            if($this->_scopeConfig->getValue("petshop/theme_install/overwrite_".$type)) {
                $overwrite = true;
            }
